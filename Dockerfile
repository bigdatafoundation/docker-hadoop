...
# Installing HADOOP 2.5.0
ADD http://archive.apache.org/dist/hadoop/core/hadoop-2.5.0/hadoop-2.5.0.tar.gz /
RUN sudo tar -zxf /hadoop-2.5.0.tar.gz
RUN sudo rm /hadoop-2.5.0.tar.gz
RUN sudo mv /hadoop-2.5.0 /usr/local
RUN sudo ln -s /usr/local/hadoop-2.5.0 /usr/local/hadoop
